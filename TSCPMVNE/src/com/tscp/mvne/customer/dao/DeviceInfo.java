...
public class DeviceInfo implements Serializable {
  ...
  private int deviceStatusId = DeviceStatus.ID_UNKNOWN;
  private String deviceStatus = DeviceStatus.DESC_UNKNOWN;
  ...
  public String toString() {
    return "DeviceInfo [deviceId=" + deviceId + ", custId=" + custId + ", accountNo=" + accountNo + ", deviceLabel="
        + deviceLabel + ", deviceValue=" + deviceValue + ", deviceStatusId=" + deviceStatusId + ", deviceStatus="
        + deviceStatus + ", modDate=" + modDate + ", effectiveDate=" + effectiveDate + ", expirationDate="
        + expirationDate + ", deviceAssociation=" + deviceAssociation + "]";
  }
