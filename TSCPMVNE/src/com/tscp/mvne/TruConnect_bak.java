...
// @WebService
public class TruConnect_bak implements TscpMvne {
  ...
  // @WebMethod
  public Account createShellAccount(AccountRequest shellAccount) {
    Customer customer = new Customer(shellAccount.getCustomerId());
    Account account = accountService.makeAccount(shellAccount);
    return createBillingAccount(customer, account);
  }
  ...
  public void init() {
    logger = TscpmvneLogger.getInstance();
    networkSystem = NetworkSystemProvider.getInstance();
    billingSystem = BillingSystemProvider.getInstance();
    notificationSystem = NotificationSystemProvider.getInstance();
    ...
    serviceInstanceService = new ServiceInstanceService();
  }
  ...
  // @WebMethod
  public PaymentRequestResponse submitPaymentRequest(PaymentRequest request) {
    return paymentService.doSubmitToMerchant(request);
  }

  // @WebMethod
  public int submitPaymentToBilling(CustPaymentTransaction transaction) throws BillingException {
