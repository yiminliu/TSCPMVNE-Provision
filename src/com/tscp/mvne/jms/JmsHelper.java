...
public class JmsHelper {
   ...
   */
  public static QueueConnectionFactory getQueueConnectionFactory(String factoryName) throws Exception {
    return (QueueConnectionFactory) jndiLookup(factoryName);
  }
   ...
   *           (or other exception) if name cannot be found
   */
  public static TopicConnectionFactory getTopicConnectionFactory(String factoryName) throws Exception {
    return (TopicConnectionFactory) jndiLookup(factoryName);
  }
  ...
  public static Object jndiLookup(String name) throws NamingException {
    ...
    try {
      object = jndiContext.lookup(name);
    } catch (NamingException e) {
