...
public class BillingSystem implements BillingInterface {
  ...
  private static short discReason = 5;

  private static final String inputPropertyFile = "com/tscp/mvne/config/truConnectDefaults.properties";
  private static final BillingServiceInterfaceSoap port = BillingServiceProvider.getInstance();
  ...
  public static int COMPONENT_INSTALL = 500000;
  public static int COMPONENT_REINSTALL = 500001;
  public static int COMPONENT_SUSPEND = 500002;
  ...
  // try {
  //
  // XMLGregorianCalendar sysdate =
  // DatatypeFactory.newInstance().newXMLGregorianCalendar(
  // new GregorianCalendar(TimeZone.getTimeZone("America/Los_Angeles")));
  //
  // int componentid =
  // Integer.parseInt(props.getProperty("component.component_id"));
  // int packageid =
  // Integer.parseInt(props.getProperty("component.package_id"));
  // short externalidtype =
  // Short.parseShort(props.getProperty("component.external_id_type"));
